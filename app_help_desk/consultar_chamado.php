...
<<<<<<< HEAD
             ...
             ?>
              ...
              <div class="card mb-3 bg-light" >
               <div class="card-body"> 
                  <h5 class= "card-title" > <?php echo $chamados_separados [1] ?> </h5>
                  <h6 class="card-subtitle mb-2 text-muted"><?php echo $chamados_separados [2] ?></h6>
                  <p class="card-text"><?php echo $chamados_separados [3] ?></p>
